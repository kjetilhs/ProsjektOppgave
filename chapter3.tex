...
\section{GPS signals}
GPS uses the signals L1 and L2 to calculate the receiver position, with the L5 signal soon fully available. More detailed information about the GPS signals can be found in \cite{GPS BOOK}
