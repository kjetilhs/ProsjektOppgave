...
Dune works by setting up individual task that can dispatch and subscribe to different \gls{imc} messages. The \gls{imc} messages will be explained in \ref{ss:IMC}.
